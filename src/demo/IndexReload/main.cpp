...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        RAMDirectoryPtr ram = newLucene<RAMDirectory>(FSDirectory::open(index), true);
        ...
        SearcherPtr s1 = newLucene<IndexSearcher>(reader);
        ...
        // Create the collection of indices.
        Collection<SearchablePtr> searchers = newCollection<SearchablePtr>(s1);
